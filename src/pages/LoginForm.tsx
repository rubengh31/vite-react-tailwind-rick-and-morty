      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#" className="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img
            ...
            src="https://imgs.search.brave.com/Tz9fE6U7hwqQ-GEwYTWjtxZY4L9oyGfgqQcl5NQk-VM/rs:fit:300:300:1/g:ce/aHR0cHM6Ly9zZWVr/bG9nby5jb20vaW1h/Z2VzL1Yvdml0ZS1s/b2dvLUJGRDQyODM5/OTEtc2Vla2xvZ28u/Y29tLnBuZw"
            alt="logo"
          />
          Ricky & Morty
        </a>
